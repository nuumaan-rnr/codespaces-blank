...
def design_validation_report(model: RackModel, cases: List[CaseResult],
    ...
    a("<hr/><p class='foot'>This report is an engineering aid generated by "
      "the rack15512 tool. All partial factors, imperfection parameters and "
...
<style>
 body{font-family:'Segoe UI',Arial,sans-serif;color:#222;margin:0;
   background:#f4f4f4}
 .page{max-width:1000px;margin:0 auto;background:#fff;padding:32px 40px}
 h1{margin:0 0 4px;font-size:26px}
 .sub{color:#666;margin:0 0 16px}
 h2{border-bottom:2px solid #1f77b4;padding-bottom:4px;margin-top:30px;
   font-size:19px}
 h3{margin-top:20px;font-size:15px;color:#1f3b5c}
 table{border-collapse:collapse;width:100%;margin:8px 0;font-size:12px}
 th,td{border:1px solid #ccc;padding:4px 6px;text-align:left;
   vertical-align:top}
 thead th{background:#eef3f8}
 table.meta,table.kv{width:auto}
 table.meta th,table.kv th{background:#f0f0f0;width:160px}
 .verdict{font-size:20px;font-weight:bold;padding:10px 14px;margin:14px 0;
   border-radius:6px;text-align:center;color:#fff}
 .verdict.pass{background:#2e7d32}.verdict.fail{background:#c62828}
 .groupres{font-weight:bold;padding:6px 10px;border-radius:4px}
 .groupres.pass{background:#e8f5e9;color:#2e7d32}
